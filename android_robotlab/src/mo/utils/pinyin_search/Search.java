...
////        String[] list = new String[]{"张伞", "张散", "张丹", "张成", "李四", "李奎","章伞"};
//        String[] list = new String[]{"赵婧琪"};
//        Search d = new Search(list);
//        System.out.println(d.search("赵进奇", 10));
////        System.out.println(d.search("李四", 10));
//        PinyinHelper.convertToPinyinString("我的名字叫赵进奇", ",", PinyinFormat.WITHOUT_TONE);
//    }
//*/
//
...
//        return targets.stream().map((Word x) -> {
//            Score s = new Score();
//            s.word = x;
